...
function AcceptContactPage() {
    ...
    useEffect(() => {
        ...
        async function acceptInvitation() {
            try {
                await postJSON<{ message: string; data: any }>(
                    "/api/contacts/accept",
                    { token },
                );
                setStatus("success");
                ...
                {status === "loading" && (
                    <div>
                        ...
                        <p className="text-6B7280">
                            Veuillez patienter pendant que nous ajoutons ce
                            contact.
                        </p>
                    </div>
                )}
            ...
            fallback={
                <div className="min-h-screen flex items-center justify-center bg-white px-4">
                    <div className="max-w-md w-full text-center">
                        ...
                        <p className="text-6B7280">Veuillez patienter.</p>
                    </div>
                </div>
            }
        >
