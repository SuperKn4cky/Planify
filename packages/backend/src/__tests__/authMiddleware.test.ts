...
describe("AuthMiddleware", () => {
    ...
    describe("authorizeUserId", () => {
        it("devrait appeler next() si req.user.id correspond à req.params.id", async () => {
            mockRequest.user = { id: testUserId };
            mockRequest.params = { id: testUserId.toString() };

            await authMiddleware.authorizeUserId(
                mockRequest as Request,
                mockResponse as Response,
                mockNext,
            );
        ...
        it("devrait retourner 403 si req.user n'est pas défini", async () => {
        ...
        it("devrait retourner 403 si req.user.id ne correspond pas à req.params.id", async () => {
            mockRequest.user = { id: testUserId };
            mockRequest.params = { id: "anotherUser" };
